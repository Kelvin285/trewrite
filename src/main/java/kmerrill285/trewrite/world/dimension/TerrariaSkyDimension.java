...
public class TerrariaSkyDimension extends OverworldDimension {
	...
	public TerrariaSkyDimension(World worldIn, DimensionType typeIn) {
...
//	        biomeProviderSettings.setBiome(BiomeT.LOWLANDS);
	        ...
	        return new TerrariaSkyChunkGenerator(world, new SkyBiomeProvider(biomeProviderSettings), overworldGenSettings);
	}
