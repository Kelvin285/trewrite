...
public class TerrariaUndergroundChunkGenerator extends NoiseChunkGenerator<OverworldGenSettings> {
	   ...
	   public TerrariaUndergroundChunkGenerator(IWorld worldIn, BiomeProvider provider, OverworldGenSettings settingsIn) {
						   ...
						   if (y == 64 + height * 100) {
							   ...
							   boolean lessn10 = false;
								...
								if (!lessn10)
								{
								   ...
								   chunkIn.setBlockState(pos2, Blocks.CAVE_AIR.getDefaultState(), false);
...
//						   }
				   ...
				   for (int y = 0; y < 256; y++) {
					   ...
					   if (chunkIn.getBlockState(pos2) == BlocksT.STONE_BLOCK.getDefaultState())
						   {
