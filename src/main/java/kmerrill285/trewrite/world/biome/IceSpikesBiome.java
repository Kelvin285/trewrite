...
public class IceSpikesBiome extends Biome {

	protected IceSpikesBiome() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					...
					)).precipitation(Biome.RainType.SNOW).category(Biome.Category.DESERT).depth(0.125F).scale(0.15F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
	      ...
	      this.setRegistryName("trewrite:ice_spikes");
