...
public class DeepFrozenOcean extends Biome {
	...
	public DeepFrozenOcean() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					...
					)).precipitation(Biome.RainType.SNOW).category(Biome.Category.DESERT).depth(-2.5F).scale(0.4F).temperature(0.5F).downfall(0.5F).waterColor(4020182).waterFogColor(329011).parent((String)null));
	      ...
	      this.setRegistryName("trewrite:deep_frozen_ocean");
