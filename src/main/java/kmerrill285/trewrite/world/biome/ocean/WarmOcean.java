...
public class WarmOcean extends Biome {
	...
	public WarmOcean() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					...
					)).precipitation(Biome.RainType.RAIN).category(Biome.Category.DESERT).depth(-1.0F).scale(0.1F).temperature(0.5F).downfall(0.5F).waterColor(4445678).waterFogColor(270131).parent((String)null));
	      ...
	      this.setRegistryName("trewrite:warm_ocean");
