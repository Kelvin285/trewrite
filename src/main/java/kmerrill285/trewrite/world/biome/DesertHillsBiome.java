...
public class DesertHillsBiome extends Biome {

	protected DesertHillsBiome() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					new SurfaceBuilderConfig(BlocksT.SAND.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState())
	      ...
	      this.setRegistryName("trewrite:desert_hills");
