...
//    	    	 			NetworkHandler.INSTANCE.send(PacketDistributor.PLAYER.with(() -> sender), new SPacketSendInventoryTerraria(msg.playername, inv));
 	...
 	private static void sendInventoryData(CPacketRequestInventoryTerraria msg, Supplier<NetworkEvent.Context> ctx, ServerPlayerEntity sender, InventoryTerraria inventory) {
