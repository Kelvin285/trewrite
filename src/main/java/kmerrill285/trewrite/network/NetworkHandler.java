package kmerrill285.trewrite.network;
...
import kmerrill285.trewrite.network.client.CPacketHeal;
import kmerrill285.trewrite.network.client.CPacketNegateFall;
...
import kmerrill285.trewrite.network.client.CPacketOpenInventoryTerraria;
import kmerrill285.trewrite.network.client.CPacketOpenInventoryVanilla;
import kmerrill285.trewrite.network.client.CPacketRemoveSummons;
...
import kmerrill285.trewrite.network.client.CPacketSaveChestTerraria;
import kmerrill285.trewrite.network.client.CPacketSyncInventoryChest;
import kmerrill285.trewrite.network.client.CPacketSyncInventoryTerraria;
import kmerrill285.trewrite.network.client.CPacketThrowItemTerraria;
...
import kmerrill285.trewrite.network.server.SPacketSendInventoryTerraria;
...
public class NetworkHandler {
	...
	public static void register() {
        ...
        registerMessage(CPacketOpenDialogGui.class, CPacketOpenDialogGui::encode, CPacketOpenDialogGui::new, CPacketOpenDialogGui::handle);
