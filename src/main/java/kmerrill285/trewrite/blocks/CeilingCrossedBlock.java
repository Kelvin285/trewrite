...
public class CeilingCrossedBlock extends BasicBlock {
	...
	public CeilingCrossedBlock(Properties properties, float hardness, float difficulty, boolean pick, boolean axe,
	...
	public CeilingCrossedBlock setShape(kmerrill285.trewrite.blocks.CrossedBlock.Shape block) {
		this.shape = block;
		return this;
	}
