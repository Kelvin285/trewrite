...
public class GrandfatherClock extends BlockT {

	   public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
	   public static final EnumProperty<DoubleBlockHalf> HALF = BlockStateProperties.DOUBLE_BLOCK_HALF;
	   
	
	public GrandfatherClock(float hardness, float difficulty, String name) {
	   ...
	   public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
		   if (!worldIn.isRemote) {
			   ...
			   long dayTime = player.getEntityWorld().getDayTime() + 6000;
	    		...
	    		if (worldIn instanceof ServerWorld)
					   worldIn.getServer().getPlayerList().sendMessage(new StringTextComponent("The current time of day is: "+day + t + AMPM).applyTextStyle(TextFormatting.BOLD));
		   }
