...
public class EntityEyeOfCthulhuBackup extends FlyingEntity implements IEntityAdditionalSpawnData, IHostile {
    ...
    public static final DataParameter<Integer> phase_data = EntityDataManager.createKey(EntityEyeOfCthulhuBackup.class, DataSerializers.VARINT);

	public boolean ALREADY_SPAWNED = false;
	public boolean REMOVED = false;
    
	 public EntityEyeOfCthulhuBackup(EntityType<? extends EntityEyeOfCthulhuBackup> type, World worldIn) {
		super(type, worldIn);
		init();
    ...
    public EntityEyeOfCthulhuBackup(World world) {
...
//						    		}
    	...
    	if (this.getDataManager().get(EntityEyeOfCthulhuBackup.phase_data).intValue() != 1) {
