...
public class EntityWormBody extends MobEntity implements IHostile {
	...
	public EntityWormBody(EntityType<? extends MobEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	public static EntityWormBody spawnWormBody(World worldIn, BlockPos pos, float life, MobEntity owner) {
		EntityWormBody head = EntitiesT.WORM_BODY.create(worldIn, null, null, null, pos, SpawnReason.EVENT, false, false);		
