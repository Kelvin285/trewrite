...
@OnlyIn(Dist.CLIENT)
public class RabbitRendererT extends MobRenderer<RabbitEntity, RabbitModel<RabbitEntity>> {
   ...
   public RabbitRendererT(EntityRendererManager renderManagerIn) {
      super(renderManagerIn, new RabbitModelT<>(), 0.3F);
   }
