...
public class CoinPortalModel extends EntityModel<EntityCoinPortal> {
	private final RendererModel bb_main;

	public CoinPortalModel() {
		textureWidth = 16;
		textureHeight = 16;
	...
	@Override
	public void render(EntityCoinPortal entity, float f, float f1, float f2, float f3, float f4, float f5) {
