...
public class IcePeaks extends Biome  {
	...
	protected IcePeaks() {
		super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
				new SurfaceBuilderConfig(BlocksT.ICE.getDefaultState(), BlocksT.ICE.getDefaultState(), BlocksT.ICE.getDefaultState())
				)).
...
//		this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntitiesT.BLUE_SLIME, 12, 4, 4));
	   ...
	   addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(TerrariaFeatures.ORES, new TerrariaOreFeatureConfig(BlocksT.ICE.getDefaultState(), BlocksT.SNOW.getDefaultState(), 35), Placement.COUNT_RANGE, new CountRangeConfig(20, 0, 0, 128)));
