...
public class FrozenHighlands extends Biome  {
	
	protected FrozenHighlands() {
		super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
				new SurfaceBuilderConfig(BlocksT.SNOW.getDefaultState(), BlocksT.SNOW.getDefaultState(), BlocksT.ICE.getDefaultState())
				)).
...
//		this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntitiesT.BLUE_SLIME, 12, 4, 4));
	   this.setRegistryName("trewrite:frozen_highlands");
	   ...
	   addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(TerrariaFeatures.ORES, new TerrariaOreFeatureConfig(BlocksT.SNOW.getDefaultState(), BlocksT.ICE.getDefaultState(), 35), Placement.COUNT_RANGE, new CountRangeConfig(20, 0, 0, 128)));
