...
public class CorruptDesertBiome extends Biome {
	...
	protected CorruptDesertBiome() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					new SurfaceBuilderConfig(BlocksT.EBONSAND.getDefaultState(), BlocksT.EBONSAND.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState())
	      ...
	      this.setRegistryName("trewrite:corrupt_desert");
