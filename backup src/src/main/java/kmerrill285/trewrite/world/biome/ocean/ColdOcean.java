...
public class ColdOcean extends Biome {
	...
	public ColdOcean() {
	      super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, 
					...
					)).precipitation(Biome.RainType.RAIN).category(Biome.Category.DESERT).depth(-1.0F).scale(0.1F).temperature(0.5F).downfall(0.5F).waterColor(4020182).waterFogColor(329011).parent((String)null));
	      ...
	      this.setRegistryName("trewrite:cold_ocean");
